...
<body style="padding-top: 80px;">
    ...
    <div class="container" style="padding-bottom: 2%;">
        <div class="jumbotron">
            <h1 class="text-center">Accel - Admin Panel</span></h1>
            <br>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row" style="padding-top: 2%; padding-bottom: 2%;">
                                    <div class="form-group text-center">
                                        <button class="btn btn-primary login-btn" name="submit" type="submit" value=" Login ">LOGIN</button>
                                    </div>
                            </div>

                            <div class="text-center">
                                <label class="login-label">Don't have an account? <a href="client-signup.php">Create a new account</a></label>
                            </div>
                        </form>
                    </div>
            </div>
